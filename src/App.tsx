...
const customers=[
  ...
  {
    id:'3',
    avatar:'https://www.disneydining.com/wp-content/uploads/2023/06/jack-sparrow-back-in-theatres.png',
  ...
  {
    id:'4',
    avatar:'https://atticusmullikin.com/wp-content/uploads/2019/05/Gollum-Smeagol-from-LOTR-The-Two-Towers.jpg',
    customerName:'Gollum',
    description:'Gollum is a fictional character in J. R. R. Tolkien\'s Middle-earth legendarium. He was introduced in the 1937 fantasy novel The Hobbit, and became important in its sequel, The Lord of the Rings. Gollum was a Stoor Hobbit of the River-folk who lived near the Gladden Fields.',
  ...
  {
    id:'5',
    avatar:'https://static.standard.co.uk/s3fs-public/thumbnails/image/2015/11/06/08/22hungergamesmain0611a.jpg?width=1200',
    customerName:'Katniss Everdeen',
    description:'Katniss Everdeen is a fictional character and the protagonist of The Hunger Games trilogy written by American author Suzanne Collins.',
